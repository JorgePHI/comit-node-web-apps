...
#### Formularios
* Los formularios en HTML son una manera muy buena de obtener datos por parte de la/el usuarix.
...
**Ejemplo:**
```html
<form action="guardar_usuarix.html" method="get" enctype="application/x-www-form-urlencoded" name="login"></form>
```
